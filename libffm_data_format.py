import pickle
import pandas as pd
output_train_ffm = 'xwd/train.ffm'
output_valid_ffm = 'xwd/valid.ffm'
output_test = 'xwd/test.ffm'
train_data_path = 'xwd/train_feat.pkl'
train_label_path = 'xwd/train_label.pkl'
valid_data_path = 'xwd/valid_feat.pkl'
valid_label_path = 'xwd/valid_label.pkl'
test_path = 'xwd/test_feat.pkl'
...
pickle.dump(full_dict,open('xwd/full_dict.pkl','wb'),protocol=4)
